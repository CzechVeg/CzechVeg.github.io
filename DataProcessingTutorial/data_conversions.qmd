...
![](images/clipboard-3056205394.png){fig-align="center" width="628"}
...
![](images/clipboard-2090306854.png){fig-align="center" width="627"}
...
![](images/clipboard-2210966045.png){fig-align="center" width="538"}
...
read_csv("data/env_measured.csv")%>%
  ...
  arrange(releve_nr) %>% 
  rename("Relevé number"=releve_nr)
```

Now you can save this file and import it to JUICE as you are used to importing headers.
